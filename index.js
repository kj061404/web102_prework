...
description.innerHTML = `A total of $${GAMES_JSON.reduce((total, game) => total + game.pledged, 0).toLocaleString()} has been raised for ${GAMES_JSON.length} games.
There ${unfundedGamesString} that have not yet met their funding goal.`;
